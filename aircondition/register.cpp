...
void ParallelMainSimulator::registerNewAtomics()
{
	...
	SingleParallelModelAdm::Instance().registerAtomic( NewAtomicFunction<Ufc>() , "Ufc" ) ;
	SingleParallelModelAdm::Instance().registerAtomic( NewAtomicFunction<Gentemp>() , "Gentemp" ) ;
	SingleParallelModelAdm::Instance().registerAtomic( NewAtomicFunction<Ucontrol>() , "Ucontrol" ) ;
	SingleParallelModelAdm::Instance().registerAtomic( NewAtomicFunction<Proptemp>() , "Proptemp" ) ;
